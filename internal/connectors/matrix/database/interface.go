...
var (
	...
	MessageTypeSetDefaultReminderTime      = MatrixMessageType("SET_DEFAULT_REMINDER_TIME")
	MessageTypeSetDefaultReminderTimeError = MatrixMessageType("SET_DEFAULT_REMINDER_TIME_ERROR")
